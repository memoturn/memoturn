import { isValidRegex, maxStarHeight } from "@memoturn/core";

// Re-exported: the ReDoS heuristic moved to core (shared with the code evaluator), but this
// remains its documented home for masking-policy callers and tests.
export { maxStarHeight };
