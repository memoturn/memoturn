...
The outermost `@observe` opens a trace; nested calls become child spans. Works for sync
and async functions.
...
(using LlamaIndex's own parent ids), including retrieved documents and embeddings.
