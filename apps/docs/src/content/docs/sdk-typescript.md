...
description: Tracing, prompts, datasets, and an OpenAI wrapper with @memoturn/sdk on npm.
---
...
The client batches events and flushes on size, on an interval, and at shutdown. Spans and
generations can nest via `span.span({...})`.
