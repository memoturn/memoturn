...
| **Provider breadth** | M | Add Gemini, Bedrock, Azure OpenAI, and a generic OpenAI-compatible base-URL provider (covers vLLM/Ollama/OpenRouter) to the provider gateway. Pays off 3×: playground, LLM-as-judge evaluators, trace replay. |
