...
| `DORIS_DB` | `memoturn` | |
| `DORIS_FE_XMX` | `4096m` | FE JVM heap cap, applied by the prod compose file. Raise on hosts with memory to spare (see [Deployment → Doris sizing](/deployment/#doris-sizing)). |
